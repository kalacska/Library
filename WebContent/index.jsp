...
<%
	session.removeAttribute("admin"); //$NON-NLS-1$
%>
		...
		<div id="container">
			<div style="padding: 20px;">
				...
				<p align="Justify">
					...
					to be ruled by a human mind, a treasure of secrets emanated by many
					minds, surviving the death of those who had produced them or had
					been their conveyors." <br> - Umberto Eco, <i>The Name of
						the Rose</i>
				</p>
				<p>
				<h3>Welcome!</h3>
				</p>
				<p align="Justify">This is a page of an imaginary library. You
					can check the list of all books available, as well as search for a
					specific author and/or title. In case you know the proper username
					and password for the admin interface, you could also have the
					opportunity to add or delete any books.</p>
