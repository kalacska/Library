...
public abstract class AbstractDao<T, PK extends Serializable> implements
	...
	public AbstractDao(EntityManager entityManager) {
		...
		ParameterizedType genericsSuperClass = (ParameterizedType) getClass()
				.getGenericSuperclass();
		this.entityClass = (Class<T>) genericsSuperClass
	 ...
	 * supplied entity, and makes the new copy managed.
	 * 
	 * Ld.:
	 * http://spitballer.blogspot.hu/2010/04/jpa-persisting-vs-merging-entites
	 * .html
	 */
	@Override
	public T update(T t) {
